...
def create_api_blueprint(app):
    """Create LterFileDraft blueprint."""
    blueprint = app.extensions["lter"].resource_draft_files.as_blueprint()
    ...
    funcs = [
        ...
        if k.startswith("init_addons_lter_file_draft") and callable(v)
    ]
    for func in funcs:
